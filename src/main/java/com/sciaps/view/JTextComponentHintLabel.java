 ...
 * @author sgowen
 */
public final class JTextComponentHintLabel extends JLabel implements FocusListener, DocumentListener
{
    public enum Show
    {
        ALWAYS,
    ...
    public JTextComponentHintLabel(String text, JTextComponent component)
    {
        this(text, component, Show.ALWAYS);
    }

    public JTextComponentHintLabel(String text, JTextComponent component, Show show)
    {
